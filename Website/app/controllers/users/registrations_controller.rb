class Users::RegistrationsController < Devise::RegistrationsController
	...
	def dashboard
		p = current_user.playlists.first
		l = current_user.links.first
		l.update_playlist(p)
		...
		@devices = current_user.devices.order(:name).limit(5)
		@playlists = current_user.playlists.order(:name).limit(10)
