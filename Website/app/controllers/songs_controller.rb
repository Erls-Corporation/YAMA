class SongsController < ApplicationController
	...
	def show
		...
		[
			...
			{ :property => "og:url", :content => song_url(@song) },
			...
			@song.artists.map { |artist| { :property => "music:musician", :content => artist_url(artist) } } |
			@song.albums.map { |album| { :property => "music:album", :content => album_url(album) } }
