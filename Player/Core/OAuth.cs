 ...
 *
 * There's one main class: OAuth.Manager.  It handles interaction
...
namespace OAuth
{
	...
	public class Manager
	{
		...
		private static string unreservedChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_.~åäöÅÄÖ";
