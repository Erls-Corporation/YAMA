...
namespace Stoffi.Core
{
	...
	public static class SettingsManager
	{
		...
		/// </summary>
		public static ViewDetailsConfig JamendoListConfig
		{
			get { return Properties.Settings.Default.JamendoListConfig; }
			set
			{
				object old = Properties.Settings.Default.JamendoListConfig;
				Properties.Settings.Default.JamendoListConfig = value;
				DispatchPropertyChanged("JamendoListConfig", old, value);
			}
		}
		...
		{
			get { return Properties.Settings.Default.FastStart; }
			set
			{
				bool same = value == Properties.Settings.Default.FastStart;
				Properties.Settings.Default.FastStart = value;
				object newValue = (object)value;
				object oldValue = same ? newValue : (object)Properties.Settings.Default.FastStart;
				...
				DispatchPropertyChanged("FastStart", oldValue, newValue);
			}
		}
		...
		public static void Export(string filename)
		{
			...
			c.FastStart = SettingsManager.FastStart;
	...
	public class PlaylistData
	{
		...
		/// </summary>
		public ObservableCollection<TrackData> Tracks { get; set; }
	...
	public class TrackData : ViewDetailsItemData
	{
		...
		{
			get { return Image; }
			set { Image = value; OnPropertyChanged("ArtURL"); }
		}
